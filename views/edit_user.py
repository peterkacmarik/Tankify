...
import flet as ft
from core.supa_base import get_supabese_client, get_current_user, SupabaseUser
...
class EditUsersViews(BaseView):
    def __init__(self, page: ft.Page, loc):
        ...
        self.user_type = None
        self.user_driver_license_category = None
        self.user_driver_license_expiry = None

        self.setup_app_bar()

        self.control_panel = self.build_control_panel()
        self.edit_user = self.handle_edit_user()
    ...
    def save_vehicle_data(self, e, vehicle_id):
        try:
            ...
            result = self.supabase_user.update_user_in_table_users(vehicle_id, current_data)
